...
while True:
    ...
    x=meds[0]
    y=meds[1]
    bottleX,bottleY,angle, dist, diffval =findBottlePosition(x,y,meds[2],1.134, 1.134)
...
particles=NAV(particles,[1.2,1.2],1)
...
while True:
    ...
    x=meds[0]
    y=meds[1]
    bottleX,bottleY,angle, dist, diffval =findBottlePosition(x,y,meds[2],1.2, 1.2)
...
particles=NAV(particles,[1.2,1],1)


particles=NAV(particles,[0.5,0.5],1)

particles=NAV(particles,[0.5,0.8],1)
