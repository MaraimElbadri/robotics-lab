...
def findBottlePosition(x,y,theta,minm, maxm):
    ...
    return bottleX,bottleY,angle, dist
...
maxHeadTurn = 1.134
tries = 0
while tries < 3: #take three tries to get a bottle
    tries = tries + 1
    ...
    bottlex, bottley, alpha, sonar = findBottlePosition(points[-1][0], points[-1][1], points[-1][2], minHeadTurn, maxHeadTurn)
